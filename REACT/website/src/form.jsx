...
function RegistrationForm() {
  ...
  const handleSubmit = (event) => {
    ...
    const college = getElementVal("college");
    const year = document.querySelector('input[name="year"]:checked').value;
    saveMessages(name, college, year);

    // Navigate to the specified route after form submission
    navigate('/food');
  };
    ...
    <div className="primary">
      <div className="innerbox">
        <div className="firstbox">
          ...
          >
            <path
              d="M-120.079 40L-154 1.52588e-05L154 1.79568e-06L120.079 40L-120.079 40Z"
              fill="black"
            />
          </svg>
        </div>
        ...
        <div className="content">
          <br />
          <h3 className="center">
            Your true identity, should <br /> you choose to reveal it
          </h3>
        ...
        <div className="secondbox">
          ...
          >
            <path
              d="M33.9207 1.48272e-06L-1.74845e-06 40L308 40L274.079 1.19804e-05L33.9207 1.48272e-06Z"
              fill="black"
            />
          </svg>
        </div>
